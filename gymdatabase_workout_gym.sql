...
--
-- Table structure for table `workout_gym`
--

DROP TABLE IF EXISTS `workout_gym`;
...
--
-- Dumping data for table `workout_gym`
--

LOCK TABLES `workout_gym` WRITE;
/*!40000 ALTER TABLE `workout_gym` DISABLE KEYS */;
/*!40000 ALTER TABLE `workout_gym` ENABLE KEYS */;
UNLOCK TABLES;
