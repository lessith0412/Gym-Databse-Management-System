...
--
-- Table structure for table `diet_gym`
--

DROP TABLE IF EXISTS `diet_gym`;
...
--
-- Dumping data for table `diet_gym`
--

LOCK TABLES `diet_gym` WRITE;
/*!40000 ALTER TABLE `diet_gym` DISABLE KEYS */;
/*!40000 ALTER TABLE `diet_gym` ENABLE KEYS */;
UNLOCK TABLES;
