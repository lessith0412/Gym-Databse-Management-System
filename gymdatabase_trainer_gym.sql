...
DROP TABLE IF EXISTS `trainer_gym`;
...
CREATE TABLE `trainer_gym` (
  ...
  KEY `AdminId` (`AdminId`),
  CONSTRAINT `trainer_gym_ibfk_1` FOREIGN KEY (`WorkOutId`) REFERENCES `workout_gym` (`WorkOutId`),
  CONSTRAINT `trainer_gym_ibfk_2` FOREIGN KEY (`AdminId`) REFERENCES `admin_gym` (`AdminId`)
...
LOCK TABLES `trainer_gym` WRITE;
/*!40000 ALTER TABLE `trainer_gym` DISABLE KEYS */;
/*!40000 ALTER TABLE `trainer_gym` ENABLE KEYS */;
UNLOCK TABLES;
